...
email=input("\033[4mjasu-enumeration\033[0m set(\033[91memail/username\033[0m) > ")
passlist = input ("\033[4mjasu-enumeration\033[0m set(\033[91mpasswd/directory\033[0m) > ")
