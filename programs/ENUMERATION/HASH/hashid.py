...
#while True:
    try:
        ...
        if first:
            ...
            h = input("\033[4mjasu-enumeration\033[0m set(\033[91midentify/hash\033[0m) > ")
        ...
        if len(jerar)==0:
            ...
            print("\n\033[91m(\033[0m!\033[91m)\033[0m Hash not Found.")
        elif len(jerar)>2:
            jerar.sort()
            print("\nPossible Hashes:")
            print("\033[92m(\033[0m+\033[92m)\033[0m "+str(algorithms[jerar[0]]))
            print("\033[92m(\033[0m+\033[92m)\033[0m "+str(algorithms[jerar[1]]))
            print("\nLeast Possible Hashes:")
            for a in range(int(len(jerar))-2):
                print("\033[92m(\033[0m+\033[92m)\033[0m "+str(algorithms[jerar[a+2]]))
        else:
            jerar.sort()
            print("\nPossible Hashes:")
            for a in range(len(jerar)):
                print("\033[91m(\033[0m>\033[92m)\033[0m "+str(algorithms[jerar[a]]))

        first = None
    except KeyboardInterrupt:
        print("\n\033[91m(\033[0m!\033[91m)\033[0m Program Interrupted")
        exit()
